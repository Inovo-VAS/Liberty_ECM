...
{
    public class FileIlangaSMSCampaign
    {
        ...
        public FileIlangaSMSCampaign(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
            ...
            this.Class = "File Ilanga SMS Campaign";
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTableIlangaSMS]"); 
                }
