...
{
    public class FileRetentionPotentialNTU
    {
        ...
        public FileRetentionPotentialNTU(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
            ...
            this.Class = "File Retention Potential NTU";
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTableRetentionPotentialNTU]"); 
                }
