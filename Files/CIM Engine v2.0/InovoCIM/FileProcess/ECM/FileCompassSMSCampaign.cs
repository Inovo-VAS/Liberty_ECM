...
{
    public class FileCompassSMSCampaign
    {
        ...
        public FileCompassSMSCampaign(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
            ...
            this.Class = "File Compass SMS Campaign";
        ...
        public async Task<bool> Master()
        {
            ...
            try
            {
                ...
                Table = TableRepo.ColumnTableSMSCampaign(Table);
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTableCompassSMS]"); 
                }
        ...
        private async Task<string> MapFileLog(string[] InData, int FileLine, int ServiceID, int LoadID, int SourceID, string IsFileDuplicate, string IsPresenceDuplicate, string IsScriptDuplicate, string MapPresenceFail, string MapScriptFail, string PhoneStatus)
        {
            try
            {
                ...
                Row["COMMENTS"] = InData[1];
                Row["OWNID"] = InData[2];
                Row["FIRSTNAME"] = InData[3];
                Row["SURNAME"] = InData[4];
                Row["PHONE"] = InData[5];
                Row["PRODUCT_DESC"] = InData[6];
                Row["PREMIUM"] = InData[7];
                Row["AMOUNT"] = InData[8];
                Row["COLLECTION_DATE"] = InData[9];
                Row["RD_DATE"] = InData[10];
                Row["ERR_CODE"] = InData[11];
                Row["ERR_DESC"] = InData[12];
                Row["BRANCH"] = InData[13];
                Row["BRANCH_NAME"] = InData[14];
                Table.Rows.Add(Row);
                return "Ok";
            }
            catch (Exception ex)
        ...
        private async Task<string> MapFileQueueComplete(string[] InData, string Status, int SourceID, int ServiceID, int LoadID)
        {
            try
            {
                ...
                Row["Comments"] = InData[5];
                Row["CustomData1"] = InData[2];
                Row["CustomData2"] = InData[7];
                Row["CustomData3"] = InData[6];
