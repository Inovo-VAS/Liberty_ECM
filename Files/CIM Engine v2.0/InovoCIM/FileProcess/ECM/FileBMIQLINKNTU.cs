...
namespace InovoCIM.FileProcess
{
    public class FileQLINKNTU
    {
        ...
        public FileQLINKNTU(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
        ...
        public async Task<bool> Master()
        {
            ...
            try
            {
                ...
                Table = TableRepo.ColumnTableQLINKNTU(Table);
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTableQlinkNTU]"); 
                }
