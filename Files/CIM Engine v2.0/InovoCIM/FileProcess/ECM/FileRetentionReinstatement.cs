...
{
    public class FileRetentionReinstatement
    {
        ...
        public FileRetentionReinstatement(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
            ...
            this.Class = "File Retention Reinstatement";
        ...
        public async Task<bool> Master()
        {
            ...
            try
            {
                ...
                Table = TableRepo.ColumnTableECMNTU(Table);
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTableRetentionReinstatement]"); 
                }
        ...
        private async Task<string> MapFilePresence  (string[] InData, int SourceID, int ServiceID, int LoadID, PhoneModel Phones)
        {
            ...
            {
                string Name = InData[2];
                Name = InData[2].Length <= 40 ? InData[2] : InData[1].Substring(0, 40);
