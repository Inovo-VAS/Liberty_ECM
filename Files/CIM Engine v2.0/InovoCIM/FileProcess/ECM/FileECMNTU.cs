...
namespace InovoCIM.FileProcess
{
    public class FileECMNTU
    {
        ...
        public FileECMNTU(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTableECMNTU]"); 
                }
