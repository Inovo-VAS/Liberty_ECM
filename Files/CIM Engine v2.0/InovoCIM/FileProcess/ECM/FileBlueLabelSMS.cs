...
namespace InovoCIM.FileProcess
{
    public class FileBlueLabel
    {
        ...
        public FileBlueLabel(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
        ...
        public async Task<bool> Master()
        {
            ...
            try
            {
                ...
                Table = TableRepo.ColumnTableBlueLabel(Table);
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTableBlueLabelSMS]"); 
                }
