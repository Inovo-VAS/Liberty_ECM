...
namespace InovoCIM.FileProcess
{
    public class FilePleaseCallMe
    {
        ...
        public FilePleaseCallMe(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
            ...
            this.Class = "File Please Call Me";
        ...
        public async Task<bool> Master()
        {
            ...
            try
            {
                ...
                Table = TableRepo.ColumnTablePleaseCallMe(Table);
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTablePleaseCallMe]"); 
                }
        ...
        private async Task<string> MapFileLog(string[] InData, int FileLine, int ServiceID, int LoadID, int SourceID, string IsFileDuplicate, string IsPresenceDuplicate, string IsScriptDuplicate, string MapPresenceFail, string MapScriptFail, string PhoneStatus)
        {
            try
            {
                ...
                Row["CellNumber"] = InData[1];
                Row["Message1"] = InData[2];
                Row["Message2"] = InData[3];
                Table.Rows.Add(Row);
                return "Ok";
            }
            catch (Exception ex)
