...
namespace InovoCIM.FileProcess
{
    public class File3WaySMS
    {
        ...
        public File3WaySMS(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTable3WaySMS]"); 
                }
