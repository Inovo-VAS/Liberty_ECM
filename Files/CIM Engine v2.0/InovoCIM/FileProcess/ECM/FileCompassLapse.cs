...
namespace InovoCIM.FileProcess
{
    public class FileCompassLapse
    {
        ...
        public FileCompassLapse(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTableCompassLapse]"); 
                }
