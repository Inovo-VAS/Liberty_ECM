...
namespace InovoCIM.FileProcess
{
    public class FileUnusedDel
    {
        ...
        public FileUnusedDel(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
            ...
            this.Class = "File Unused Delivered";
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTableUnusedDel]"); 
                }
