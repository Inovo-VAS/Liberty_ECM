...
{
    public class FileBMIOlicoMoneyshop
    {
        ...
        public FileBMIOlicoMoneyshop(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
            ...
            this.Class = "File Olico Moneyshop";
        ...
        public async Task<bool> Master()
        {
            ...
            try
            {
                ...
                Table = TableRepo.ColumnTableOlicoMoneyshop(Table);
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTableOlicoMoneyshop]"); 
                }
