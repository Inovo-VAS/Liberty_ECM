...
{
    public class FileQuotedHotLeads
    {
        ...
        public FileQuotedHotLeads(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
            ...
            this.Class = "File Quoted Hot Leads";
        ...
        public async Task<bool> Master()
        {
            ...
            try
            {
                ...
                Table = TableRepo.ColumnTableQuotedHotLeads(Table);
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTableQuotedHotLeads]"); 
                }
        ...
        private async Task<string> MapFileLog(string[] InData, int FileLine, int ServiceID, int LoadID, int SourceID, string IsFileDuplicate, string IsPresenceDuplicate, string IsScriptDuplicate, string MapPresenceFail, string MapScriptFail, string PhoneStatus)
        {
            try
            {
                ...
                Row["ProductName_&_StatusDate"] = InData[4];
                Row["Premium"] = InData[5];
                Row["DOB"] = InData[6];
                Table.Rows.Add(Row);
                return "Ok";
            }
        ...
        {
            try
            { //Source_ID,Name,IDNumber,CellNumber,ProductName_&_StatusDate,Premium,DOB
                string Name = InData[1];
                Name = InData[1].Length <= 40 ? InData[1] : InData[1].Substring(0, 40);
                ...
                Row["Comments"] = InData[4];
                Row["CustomData1"] = InData[5];
                Row["CustomData2"] = InData[6];
