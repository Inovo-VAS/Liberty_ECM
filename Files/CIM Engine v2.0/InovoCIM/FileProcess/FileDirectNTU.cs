...
namespace InovoCIM.FileProcess
{
    public class FileDirectNTU
    {
        ...
        public FileDirectNTU(string _InstanceID, ImportFile _ImportFileModel, FileInfo _File)
        {
        ...
        public async Task<bool> Master()
        {
            ...
            try
            {
                ...
                Table = TableRepo.ColumnTableBrokerLapse(Table);
        ...
        private async Task<string> SendToDatabase()
        {
            ...
            try
            {
                ...
                {
                    int result = Sql.SendToInovoCIM(Table, "[ECM].[FileTableDirectNTU]");
                }
        ...
        public async Task<int> CalculateLoadID(string[] InData, int ServiceID)
        {
            ...
            try
            {
                ...
                {
                    LoadModel Load = new LoadModel(this.InstanceID, ServiceID, "1", this.ImportFileModel.Partial, "Batch");
